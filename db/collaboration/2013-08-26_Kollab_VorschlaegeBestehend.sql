...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 26. Aug 2013 um 14:29
...
(5, 'rmuetzner', 'ff3038b853a7f14e2e52a7a1e3e5a0bc', 'x1DoBoKu8VRi', 'Mützner', 'Robert', NULL, NULL, 'robert@muetzner.de', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, 1, 0),
(11, 'urbauer', '53176d985b3a9972db5d7dc97ac16e76', '841rVkCtyI2o', 'Urbauer', 'Philipp', NULL, NULL, 'philipp.urbauer@technikum-wien.at', NULL, NULL, NULL, NULL, NULL, 1, 2, NULL, NULL, 1, 0);
...
CREATE TABLE IF NOT EXISTS `discussiongroup` (
  ...
  `headOfGroupId` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
