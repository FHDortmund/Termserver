...
--
-- Definition of table `assigned_term`
--

DROP TABLE IF EXISTS `assigned_term`;
CREATE TABLE `assigned_term` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `assigned_term_ibfk_1` FOREIGN KEY (`collaborationUserId`) REFERENCES `collaborationuser` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `assigned_term`
--

/*!40000 ALTER TABLE `assigned_term` DISABLE KEYS */;
/*!40000 ALTER TABLE `assigned_term` ENABLE KEYS */;
...
INSERT INTO `collaborationuser` (`id`,`username`,`password`,`salt`,`name`,`firstName`,`city`,`country`,`email`,`note`,`phone`,`street`,`title`,`zip`,`sendMail`,`organisation_ID`,`activated`,`activation_md5`,`enabled`,`hidden`,`activation_time`,`deleted`) VALUES 
 (34,'muetzner','16d7a4fca7442dda3ad93c9a726597e4','','Mützner','Robert',NULL,NULL,'robert.muetzner@fh-dortmund.de',NULL,NULL,NULL,NULL,NULL,1,16,1,NULL,1,0,NULL,0),
 (37,'tuser','cf3128292973163d32e7725d6e18f18b','f1A4aa30e9QM','User','Test',NULL,NULL,'robert.muetzner@fh-dortmund.de',NULL,NULL,NULL,NULL,NULL,1,17,1,'',1,0,'2015-10-19 11:11:49',0),
 (38,'tadmin','d1b0041242ccb5a1198eb66714734d0f','FN8jo9S6m7W4','Admin','Term',NULL,NULL,'robert.muetzner@fh-dortmund.de',NULL,NULL,NULL,NULL,NULL,1,18,1,'',1,0,'2015-10-19 11:18:48',0);
...
INSERT INTO `organisation` (`id`,`organisation`,`organisationAbbr`,`organisationLink`) VALUES 
 ...
 (15,'CAS',NULL,NULL),
 (16,'BMG',NULL,NULL),
 (17,'FH Dortmund',NULL,NULL),
 (18,'FH Dortmund',NULL,NULL);
...
CREATE TABLE `proposal` (
  ...
  `objectVersionId` bigint(20) unsigned DEFAULT NULL,
  `objectName` varchar(255) DEFAULT NULL,
  `objectVersionName` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `collaborationUserID` (`collaborationUserId`),
...
CREATE TABLE `role` (
  ...
  `mayAdminProposal` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `role` (`id`,`adminFlag`,`name`,`mayChangeStatus`,`mayAdminProposal`) VALUES 
 (1,0,'Diskussionsteilnehmer',NULL,NULL),
 (2,0,'Inhaltsverwalter',NULL,NULL),
 (3,0,'Rezensent',NULL,NULL),
 (4,1,'Terminologieadministrator',NULL,NULL);
...
INSERT INTO `sys_param` (`id`,`name`,`validity_domain`,`object_id`,`modify_level`,`java_datatype`,`value`,`description`) VALUES 
 (1,'mail_sender',1313,NULL,1313,'string','ehealth@fh-dortmund.de',NULL),
 (2,'mail_host',1313,NULL,1313,'string','mailout2.fh-dortmund.de',NULL),
 (4,'mail_user',1313,NULL,1313,'string','ehealth',NULL),
 (5,'mail_password',1313,NULL,1313,'string','derEHealthBoSS#',NULL),
 (6,'mail_port',1313,NULL,1313,'string','587',NULL),
 (7,'mail_ssl_enable',1313,NULL,1313,'string','false',NULL),
...
--
-- Definition of table `userprivilege`
--
...
CREATE TABLE `userprivilege` (
  ...
  `objectVersionId` bigint(20) DEFAULT NULL,
  `sendMail` tinyint(1) DEFAULT NULL,
  `collaborationuser_id` bigint(20) NOT NULL,
  `role_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_userPrivilege_collaborationuser1_idx` (`collaborationuser_id`),
  KEY `fk_userPrivilege_role1_idx` (`role_id`),
  CONSTRAINT `fk_userPrivilege_collaborationuser1` FOREIGN KEY (`collaborationuser_id`) REFERENCES `collaborationuser` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_userPrivilege_role1` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
