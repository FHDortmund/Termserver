...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 04. Sep 2013 um 16:20
...
--
-- Daten für Tabelle `assigned_term`
--

INSERT INTO `assigned_term` (`id`, `classId`, `classname`, `collaborationUserId`) VALUES
(1, 186, 'CodeSystem', 11),
(2, 187, 'CodeSystem', 11),
(3, 109, 'ValueSet', 11),
(4, 188, 'CodeSystem', 11),
...
(2, 'mail_host', 1313, NULL, 1313, 'string', '172.18.8.30', NULL),
(4, 'mail_user', 1313, NULL, 1313, 'string', '', NULL),
(5, 'mail_password', 1313, NULL, 1313, 'string', '', NULL),
(6, 'mail_port', 1313, NULL, 1313, 'string', '25', NULL),
...
(9, 'weblink', 1313, NULL, 1313, 'string', 'https://test.gesundheit.gv.at/TermBrowser', NULL),
(10, 'mail_auth', 1313, NULL, 1313, 'string', 'false', NULL);
