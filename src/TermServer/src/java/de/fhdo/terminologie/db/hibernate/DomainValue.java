 ...
 * 
 * edited 2017-06-21 <robert.muetzner@fh-dortmund.de>: added value set support
 */
...
public class DomainValue implements java.io.Serializable
{
  ...
  private Set<ValueSet> valueSets = new HashSet<ValueSet>(0);
  ...
  @ManyToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
  @JoinTable(name = "domain_value_has_value_set", joinColumns =
  {
    @JoinColumn(name = "domain_value_domainValueId", nullable = false, updatable = false)
  }, inverseJoinColumns =
  {
    @JoinColumn(name = "value_set_id", nullable = false, updatable = false)
  })
