 ...
 */
@XmlRootElement
@XmlType(name = "", propOrder = { "returnInfos", "valueSetMetadataValue"})
public class ReturnValueSetConceptMetadataResponseType
{
  private ReturnType returnInfos;
  private List<ValueSetMetadataValue> valueSetMetadataValue;
  
  public ReturnValueSetConceptMetadataResponseType()
  {
  ...
  public void setReturnInfos(ReturnType returnInfos)
  {
    ...
    public void setValueSetMetadataValue(List<ValueSetMetadataValue> valueSetMetadataValue) {
        this.valueSetMetadataValue = valueSetMetadataValue;
    }
}
