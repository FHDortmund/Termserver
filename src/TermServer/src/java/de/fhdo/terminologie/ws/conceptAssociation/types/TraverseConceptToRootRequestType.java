...
public class TraverseConceptToRootRequestType
{
  ...
  private Boolean directionToRoot;
  ...
  /**
   * @return the directionToRoot
   */
  public Boolean getDirectionToRoot()
  {
    return directionToRoot;
  }

  /**
   * @param directionToRoot the directionToRoot to set
   */
  public void setDirectionToRoot(Boolean directionToRoot)
  {
    this.directionToRoot = directionToRoot;
  }
