 ...
 */
@XmlRootElement
@XmlType(name = "", propOrder = { "returnInfos", "metadataParameter"})
public class ListMetadataParameterResponseType
{
  private ReturnType returnInfos;
  private List<MetadataParameter> metadataParameter;
  
  public ListMetadataParameterResponseType()
  {
   ...
   */
  public void setMetadataParameter(List<MetadataParameter> metadataParameter)
  {
