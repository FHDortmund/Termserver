...
public class ActualProceedingsResponseType 
{
    ...
    private List<ActualProceeding> actualProceedings;
    ...
    public List<ActualProceeding> getActualProceedings() {
        return actualProceedings;
    }

    public void setActualProceedings(List<ActualProceeding> actualProceedings) {
        this.actualProceedings = actualProceedings;
    }
