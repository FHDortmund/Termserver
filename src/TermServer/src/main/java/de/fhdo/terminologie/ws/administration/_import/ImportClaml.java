...
public class ImportClaml
{
  ...
  private void loadClamlXML(InputStream is) throws Exception
  {
    ...
    //inputFactory.setProperty(XMLInputFactory.VALIDATING, Boolean.FALSE);

    // BufferedReader in = new BufferedReader(new InputStreamReader(is, StandardCharsets.UTF_8));
    // Setup a new eventReader
    //XMLEventReader eventReader = inputFactory.createXMLEventReader(is);
    XMLEventReader eventReader = inputFactory.createXMLEventReader(new BufferedReader(new InputStreamReader(is, StandardCharsets.UTF_8)));
