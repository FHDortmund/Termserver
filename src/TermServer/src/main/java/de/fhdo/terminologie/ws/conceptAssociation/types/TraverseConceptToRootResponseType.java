 ...
 */
@XmlRootElement
@XmlType(name = "", propOrder = { "returnInfos", "codeSystemEntityVersionRoot"})
public class TraverseConceptToRootResponseType
{
  private ReturnType returnInfos;
  private CodeSystemEntityVersion codeSystemEntityVersionRoot;
  ...
  /**
   * @return the codeSystemEntityVersionRoot
   */
  ...
  /**
   * @param codeSystemEntityVersionRoot the codeSystemEntityVersionRoot to set
   */
  public void setCodeSystemEntityVersionRoot(CodeSystemEntityVersion codeSystemEntityVersionRoot)
  {
    this.codeSystemEntityVersionRoot = codeSystemEntityVersionRoot;
  }
}
