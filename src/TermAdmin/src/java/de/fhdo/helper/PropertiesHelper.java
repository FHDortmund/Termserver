...
public class PropertiesHelper
{
  ...
  private void loadData()
  {
    ...
    try
    {
      ...
      // load properties
      loginClassname = config.getProperty("login.classname", "de.fhdo.authorization.UsernamePasswordMethod");
      loginZul = config.getProperty("login.zul", "/gui/authorization/loginUser.zul");
      ...
      logger.debug("login_classname: " + loginClassname);
      logger.debug("loginZul: " + loginZul);
