 ...
 */
public class ImportCS_LOINC implements IImport, javax.xml.ws.AsyncHandler<ImportCodeSystemResponse>, EventListener
{
  ...
  public ImportCS_LOINC(long FormatId, Window win)
  {
    formatId = FormatId;
    window = win;
  }
  ...
  public boolean startImport(byte[] bytes, final Progressmeter progress, Label labelInfo, CodeSystem codeSystem, ValueSet valueSet)
  {
    ...
    request.getImportInfos().setOrder(false); // TODO update verfügbar machen
