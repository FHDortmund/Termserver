...
public class SysParamDetails extends Window implements org.zkoss.zk.ui.ext.AfterCompose
{
  ...
  private de.fhdo.collaboration.db.classes.SysParam sysParam;
    ...
    try
    {
      ...
      if (paramId > 0)
      {
        ...
        try
        {
          ...
          sysParam = (de.fhdo.collaboration.db.classes.SysParam) hb_sessionS.get(de.fhdo.collaboration.db.classes.SysParam.class, paramId);
        }
        catch (Exception ex)
        {
      ...
      else
      {
        ...
        sysParam = new de.fhdo.collaboration.db.classes.SysParam();
   ...
   * @return the sysParam
   */
  public de.fhdo.collaboration.db.classes.SysParam getSysParam()
  {
    return sysParam;
  }
   ...
   */
  public void setSysParam(de.fhdo.collaboration.db.classes.SysParam sysParam)
  {
