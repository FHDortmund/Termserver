...
public class VersionHelper
{
  ...
  public String getVersion()
  {
    ...
    if (lastDate == null || termserverVersion == null || termserverVersion.length() == 0 || (new Date().getTime() > lastDate.getTime() + RELOAD_AFTER_MS))
    {
  ...
  public Date getDate()
  {
    if (lastDate == null || termserverVersion == null || termserverVersion.length() == 0 || lastDate.getTime() + RELOAD_AFTER_MS > new Date().getTime())
    {
