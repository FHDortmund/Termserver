...
public class DualComposerUser extends SelectorComposer<Component> {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        Set<PrivilegeUserInfo> data = (Set<PrivilegeUserInfo>) Executions.getCurrent().getAttribute("userData");
        dualLBoxUser.setModel(new ListModelList<PrivilegeUserInfo>(data));
    }
}
