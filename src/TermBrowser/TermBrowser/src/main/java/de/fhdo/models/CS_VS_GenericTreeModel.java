...
public class CS_VS_GenericTreeModel
{
  ...
  private void initData()
  {
    ...
    try
    {
      ...
      logger.debug("Zeige Details... - Status: " + response.getReturnInfos().getStatus());
      

      if (response.getReturnInfos().getStatus() == Status.OK)
      {
        logger.debug("Anz: " + response.getDomainValue().size());
        
        for(DomainValue dv : response.getDomainValue())
        {
          //logger.debug("Domain found: " + dv.getDomainDisplay() + ", Anz CS: " + dv.getCodeSystems().size() + ", Anz VS: " + dv.getValueSets().size());
          logger.debug("Domain found: " + dv.getDomainDisplay());
          logger.debug("Domain found: " + dv.getDomainDisplay() + ", Anz CS: " + dv.getCodeSystems().size() + ", Anz VS: " + dv.getValueSets().size());
          //logger.debug("Domain found: " + dv.getDomainDisplay() + ", Anz CS: " + dv.getCodeSystems().size());
        }
      ...
      {
        // show error message#
        logger.debug("FEHLER beim Abruf");
