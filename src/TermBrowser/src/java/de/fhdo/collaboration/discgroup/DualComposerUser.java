...
public class DualComposerUser extends SelectorComposer<Component> {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        Set<DiscussionGroupUserInfo> data = (Set<DiscussionGroupUserInfo>) Executions.getCurrent().getAttribute("userData");
        dualLBoxUser.setModel(new ListModelList<DiscussionGroupUserInfo>(data));
    }
}
