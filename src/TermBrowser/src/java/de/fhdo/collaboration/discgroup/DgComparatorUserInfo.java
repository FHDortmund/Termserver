 ...
 */
public class DgComparatorUserInfo  implements Comparator{
    ...
    public DgComparatorUserInfo(boolean ascending, int choosenMode){
        asc = ascending;
        mode = choosenMode;
    }
    
    public int compare(Object o1, Object o2) {
        DiscussionGroupUserInfo dcui1 = (DiscussionGroupUserInfo)o1,
                                dcui2 = (DiscussionGroupUserInfo)o2;
