...
/**
 *
 * @author Sven Becker edited 2014-08-27 by Robert Mützner
 * <robert.muetzner@fh-dortmund.de>
 */
public class PopupCodeSystem_old extends PopupWindow implements IUpdateModal
{
  ...
  private Toolbarbutton buttonExpandCS;
  private Toolbarbutton buttonExpandCSV;

  private Groupbox gbVersion;

  private Row rowDescriptionEng,
          rowValidityRange,
          rowDateFrom,
          rowDateTo,
          rowCSVStatus,
          rowCSVStatusLastEdited,
          rowCSVPrefLang,
          rowCSVLicence,
          rowCSVLicenceHolder;
  ...
  public void doAfterComposeCustom()
  {
    ...
    //DomainHelper.getInstance().fillCombobox(cboxCSVValidityRange, de.fhdo.Definitions.DOMAINID_CODESYSTEMVERSION_VALIDITYRANGE, csv.getValidityRange());
  }
  ...
  private void loadDetails()
  {
    ...
    if (csv == null)
      logger.debug("csv ist null");
    else
      logger.debug("csv.val: " + csv.getValidityRange());

    DomainHelper.getInstance().fillCombobox(cboxCSVValidityRange, de.fhdo.Definitions.DOMAINID_CODESYSTEMVERSION_VALIDITYRANGE,
            csv == null ? "" : "" + csv.getValidityRange());
  ...
  protected void initializeDatabinder()
  {
    ...
    //binderVisibility = new AnnotateDataBinder(window);
...
//    binderVisibility.bindBean("visibility", PropertiesHelper.getInstance());
//    binderVisibility.bindBean("guiCodesystemMinimalVisible", guiCodesystemMinimalVisible);
//    binderVisibility.bindBean("guiCodesystemVersionMinimalVisible", guiCodesystemVersionMinimalVisible);
//
//    binderVisibility.bindBean("guiCodesystemExpandableVisible", guiCodesystemExpandableVisible);
//    binderVisibility.bindBean("guiCodesystemVersionExpandableVisible", guiCodesystemVersionExpandableVisible);
//
//    binderVisibility.loadAll();
...
//  }
  ...
  protected void editmodeDetails()
  {
    ...
    // only Codesystem details
    // TODO show all versions in a list?
    gbVersion.setVisible(csv != null);
  }
  ...
  protected void create()
  {
    ...
    if (parameterCorrect)
    {
      if (cboxCSVValidityRange.getSelectedItem() != null)
      {
        ...
        try
        {
          csv.setValidityRange(Long.parseLong(DomainHelper.getInstance().getComboboxCd(cboxCSVValidityRange)));
        }
        catch (Exception ex)
        {
        }
        logger.debug("getValidityRange: " + csv.getValidityRange());
        //if (cboxCSVValidityRange.getSelectedItem() != null)
  ...
  @NotifyChange("guiCodesystemMinimalVisible")
  @Command
  public void onClick$buttonExpandCS()
  {
...
//
  ...
  @NotifyChange("guiCodesystemVersionMinimalVisible")
  public void onClick$buttonExpandCSV()
  {
...
//
  ...
  private void showDetailsVisibilty()
  {
    ...
    // code system
    rowDescriptionEng.setVisible(guiCodesystemMinimalVisible);
    buttonExpandCS.setVisible(guiCodesystemExpandableVisible);
    
    // code system version
    rowValidityRange.setVisible(guiCodesystemVersionMinimalVisible);
    rowDateFrom.setVisible(guiCodesystemVersionMinimalVisible);
    rowDateTo.setVisible(guiCodesystemVersionMinimalVisible);
    rowCSVStatus.setVisible(guiCodesystemVersionMinimalVisible);
    rowCSVStatusLastEdited.setVisible(guiCodesystemVersionMinimalVisible);
    rowCSVPrefLang.setVisible(guiCodesystemVersionMinimalVisible);
    rowCSVLicence.setVisible(guiCodesystemVersionMinimalVisible);
    rowCSVLicenceHolder.setVisible(guiCodesystemVersionMinimalVisible);
    buttonExpandCSV.setVisible(guiCodesystemVersionExpandableVisible);
  ...
  /**
   * @return the guiCodesystemMinimalVisible
   */
  public boolean isGuiCodesystemMinimalVisible()
  {
    return guiCodesystemMinimalVisible;
  }

  /**
   * @param guiCodesystemMinimalVisible the guiCodesystemMinimalVisible to set
   */
  public void setGuiCodesystemMinimalVisible(boolean guiCodesystemMinimalVisible)
  {
    this.guiCodesystemMinimalVisible = guiCodesystemMinimalVisible;
  }

  /**
   * @return the guiCodesystemVersionMinimalVisible
   */
  public boolean isGuiCodesystemVersionMinimalVisible()
  {
    return guiCodesystemVersionMinimalVisible;
  }

  /**
   * @param guiCodesystemVersionMinimalVisible the
   * guiCodesystemVersionMinimalVisible to set
   */
  public void setGuiCodesystemVersionMinimalVisible(boolean guiCodesystemVersionMinimalVisible)
  {
    this.guiCodesystemVersionMinimalVisible = guiCodesystemVersionMinimalVisible;
  }

  /**
   * @return the guiCodesystemExpandableVisible
   */
  public boolean isGuiCodesystemExpandableVisible()
  {
    return guiCodesystemExpandableVisible;
  }

  /**
   * @param guiCodesystemExpandableVisible the guiCodesystemExpandableVisible to
   * set
   */
  public void setGuiCodesystemExpandableVisible(boolean guiCodesystemExpandableVisible)
  {
    this.guiCodesystemExpandableVisible = guiCodesystemExpandableVisible;
  }

  /**
   * @return the guiCodesystemVersionExpandableVisible
   */
  public boolean isGuiCodesystemVersionExpandableVisible()
  {
    return guiCodesystemVersionExpandableVisible;
  }

  /**
   * @param guiCodesystemVersionExpandableVisible the
   * guiCodesystemVersionExpandableVisible to set
   */
  public void setGuiCodesystemVersionExpandableVisible(boolean guiCodesystemVersionExpandableVisible)
  {
    this.guiCodesystemVersionExpandableVisible = guiCodesystemVersionExpandableVisible;
  }
