...
public class TreeModelCS
{
  ...
  public static TreeModelCS getInstance()
  {
    if (instance == null)
      instance = new TreeModelCS();
  ...
  public ArrayList<CodeSystemVersion> getCsvList()
  {
    return csvList;
  }
...
//        treeModel = new TreeModel(tn_root);
  ...
  private TreeModel createModel()
  {
    ...
    return new TreeModel(new TreeNode(null, new LinkedList()));
  }

  private TreeNode createTreeNode(Object x)
  {
