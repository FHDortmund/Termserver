 ...
 */
public class ComparatorConceptDesignationDescending implements Comparator
{
  ...
  public int compare(Object o1, Object o2)
  {
    if (o1 != null && o2 != null)
    {
      if (o1 instanceof DefaultTreeNode)
      {
        ...
        String term1 = csev1.getCodeSystemConcepts().get(0).getTerm();
        String term2 = csev2.getCodeSystemConcepts().get(0).getTerm();
