 ...
 * @author Becker
 */
public class ListitemRendererCsMetadataList implements ListitemRenderer {
    private static org.apache.log4j.Logger logger = de.fhdo.logging.Logger4j.getInstance().getLogger();
    private boolean editableMetadataList;

    public ListitemRendererCsMetadataList(boolean editableMetadataList) {
    ...
    public void render(Listitem lstm, Object o, int index) throws Exception {
        ...
        if(editableMetadataList){
            ...
            textBox.setText(csmv.getParameterValue());
