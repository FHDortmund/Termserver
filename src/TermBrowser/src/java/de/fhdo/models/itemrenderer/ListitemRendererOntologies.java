 ...
 * @author Becker
 */
public class ListitemRendererOntologies implements ListitemRenderer
{

  private static org.apache.log4j.Logger logger = de.fhdo.logging.Logger4j.getInstance().getLogger();
  private long versionId;

  public ListitemRendererOntologies(long id)
  {
    versionId = id;
  }
  ...
  public void render(Listitem lstm, Object o, int index) throws Exception
  {
    ...
    Listcell cellPreferred = new Listcell();
    ...
    if (csev != null)
    {
      ...
      cb.setDisabled(true);
      cb.setChecked(csev.getCodeSystemConcepts().get(0).isIsPreferred());
      cellPreferred.appendChild(cb);
    }

    lstm.appendChild(cellAssociationType);
    lstm.appendChild(cellEntity);
    lstm.appendChild(cellCode);
    lstm.appendChild(cellPreferred);
  }
}
