...
public class Logger4j
{
  ...
  private static final String LOG4J_CONFIG_FILE = "termbrowser.log4j.cfg.xml";

  //private static final String LOG4J_CONFIG_FILE =
  //        "/var/www/www.term.mi.fh-dortmund.de/termserver/termserver_log4j.xml";

  //private static final String LOG4J_LOG_FILE =
//          "/var/www/www.term.mi.fh-dortmund.de/termserver/term.log";
  private static final String LOG4J_LOG_FILE =
          "termBrowser.log";
  ...
  private void initLogger()
  {
    try
    {
      ...
      /**/ //String sFile = "/data0/web/tomcat_term1/conf/termBrowser_log4j_config.xml";
      /********************************************/
      
      //String sLogfile = System.getProperty("catalina.base") + "/logs/" + LOG4J_LOG_FILE;
